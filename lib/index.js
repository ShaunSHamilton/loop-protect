...
var generateDateComparison = function generateDateComparison() {
  ...
  return t.ifStatement(generateTimeoutElapsed({
    ...
    line: line,
    ch: ch
  }) : t.returnStatement());//t.breakStatement());
};
...
var generateExtra = function generateExtra() {
  ...
  return t.blockStatement([t.expressionStatement(t.callExpression(extra, [t.numericLiteral(line), t.numericLiteral(ch)])), t.returnStatement()]); // t.breakStatement()]);
};
